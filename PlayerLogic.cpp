...
void PlayerLogic::Update(float deltatime, sf::RenderWindow& window, EnemyLogic& enemy){
	if (playerAlive) {
		...
		for (int i = 0; i < projectiles.size(); i++) {
			...
			if (mycharacter == "Robin") {
				...
				{
					enemy.changeHealth(1, -10);
					projectiles.erase(projectiles.begin() + i);
					i--;
					continue;
				}
				if (MathLogic::checkCollision(projectiles[i].getFireballSpriteGlobalBounds(), enemy.getEnemy2Bounds()) && enemy.getEnemy2Health() > 0)
				{
					enemy.changeHealth(2, -10);
					projectiles.erase(projectiles.begin() + i);
					i--;
					continue;
				}
				if (MathLogic::checkCollision(projectiles[i].getFireballSpriteGlobalBounds(), enemy.getEnemy3Bounds()) && enemy.getEnemy3Health() > 0)
				{
					enemy.changeHealth(3, -10);
					projectiles.erase(projectiles.begin() + i);
					i--;
					continue;
				}
			...
			if (mycharacter == "Frieren") {
				...
				if (MathLogic::checkCollision(projectiles[i].getPurpleFlameSpriteGlobalBounds(), enemy.getEnemy2Bounds()) && enemy.getEnemy2Health() > 0)
				{
					enemy.changeHealth(2, -10);
					projectiles.erase(projectiles.begin() + i);
					i--;
				...
				if (MathLogic::checkCollision(projectiles[i].getPurpleFlameSpriteGlobalBounds(), enemy.getEnemy3Bounds()) && enemy.getEnemy3Health() > 0)
				{
					enemy.changeHealth(3, -10);
					projectiles.erase(projectiles.begin() + i);
					i--;
			...
			if (mycharacter == "Hinata") {
				...
				if (MathLogic::checkCollision(projectiles[i].getRasenshurikenSpriteGlobalBounds(), enemy.getEnemy2Bounds()) && enemy.getEnemy2Health() > 0)
				{
					enemy.changeHealth(2, -10);
					projectiles.erase(projectiles.begin() + i);
					i--;
				...
				if (MathLogic::checkCollision(projectiles[i].getRasenshurikenSpriteGlobalBounds(), enemy.getEnemy3Bounds()) && enemy.getEnemy3Health() > 0)
				{
					enemy.changeHealth(3, -10);
					projectiles.erase(projectiles.begin() + i);
					i--;
